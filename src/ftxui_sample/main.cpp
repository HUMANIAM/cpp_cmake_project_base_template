...
// configuration step. It creates a namespace called `cpp_cmake_project_base_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_cmake_project_base_template::cmake::project_name, cpp_cmake_project_base_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_cmake_project_base_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
